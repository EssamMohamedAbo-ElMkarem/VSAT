...
Name        Eglin_AFB_AN-FPS_85_PAR_STDN_EG2F

	BEGIN CentroidPosition

		CentralBody            Earth
		DisplayCoords          Geodetic
		EcfLatitude            3.05725279400000e+01
		EcfLongitude           -8.62147174200000e+01
		EcfAltitude            3.77110000000000e+01
		HeightAboveGround      0.00000000000000e+00
		ComputeTrnMaskAsNeeded Off
		AzElMask               AzElMaskFile: Eglin_AFB_AN-FPS_85_PAR_STDN_EG2F.aem
...
BEGIN Extensions
    ...
    BEGIN Desc
    Begin ShortText
Eglin AFB AN-FPS 85 PAR STDN EG2F
Name:           Eglin AFB AN-FPS 85 PAR STDN EG2F
Country:        UnitedStates
Location:       Eglin AFB, Florida
Status:         Active
Type:           RadarStation
Notes:          NASA# 4345 || Equipment: C-bd FPS-85 az-el   || Remarks: 6-81 pts + or - 60deg. Landing aid. || The world's first large phased array radar, the AN/FPS-85 was constructed in the 1960s at Eglin AFB. Originally made for submarine missile warning, the radar's mission changed to space surveillance in 1987.  Operated by the 20th Space Control Squadron under the 21st Space Wing.
Sources:                       NASA Directory of Station Locations Jan 27 2010
               http://www.globalsecurity.org/space/agency/20spss.htm
