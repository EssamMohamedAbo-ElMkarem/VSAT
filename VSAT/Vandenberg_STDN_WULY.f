...
Name        Vandenberg_STDN_WULY

	BEGIN CentroidPosition

		CentralBody            Earth
		DisplayCoords          Geodetic
		EcfLatitude            3.46554133600000e+01
		EcfLongitude           -1.20555984720000e+02
		EcfAltitude            7.52300000000000e+01
		HeightAboveGround      0.00000000000000e+00
		ComputeTrnMaskAsNeeded Off
		AzElMask               AzElMaskFile: WULY.aem
...
BEGIN Extensions
    ...
    BEGIN Desc
    Begin ShortText
Vandenberg STDN WULY
Name:           Vandenberg STDN WULY
Country:        UnitedStates
Location:       Vandenberg AFB, California
Status:         Active
Type:           GroundStation
Notes:          NASA# 4215 || Equipment: Tlm S-bd 8.5m az-el   || Remarks: 10-91 WSMC 27603 
