...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN SoftVTR
            OutputFormat     WMV
            Directory        C:\Users\elhussein\Documents\STK 11 (x64)\vsat
            BaseName         Frame
            Digits           4
            Frame            0
...
BEGIN References
    ...
    Instance Place/Cairo
        Chain/Chain1
        Place/Cairo
        Place/Cairo/Sensor/downRecev
        Satellite/Satellite/Sensor/downTrans
    END Instance
    Instance Place/Cairo/Sensor/downRecev
        Chain/Chain1
        Place/Cairo/Sensor/downRecev
        Place/Cairo/Sensor/downRecev/Receiver/Receiver2
    END Instance
    Instance Place/Cairo/Sensor/downRecev/Receiver/Receiver2
        Chain/Chain1
        Place/Cairo/Sensor/downRecev/Receiver/Receiver2
    END Instance
    Instance Place/California
        Chain/Chain1
        Place/California
        Place/California/Sensor/upTrans
        Satellite/Satellite/Sensor/upRecev
    END Instance
    Instance Place/California/Sensor/upTrans
        Chain/Chain1
        Place/California/Sensor/upTrans
        Place/California/Sensor/upTrans/Transmitter/Transmitter1
    END Instance
    Instance Place/California/Sensor/upTrans/Transmitter/Transmitter1
        Chain/Chain1
        Place/California/Sensor/upTrans/Transmitter/Transmitter1
    END Instance
    Instance Satellite/Satellite
        ...
        Satellite/Satellite/Sensor/upRecev
    END Instance
    Instance Satellite/Satellite/Sensor/downTrans
        Chain/Chain1
        Satellite/Satellite/Sensor/downTrans
        Satellite/Satellite/Sensor/downTrans/Transmitter/Transmitter2
    END Instance
    Instance Satellite/Satellite/Sensor/downTrans/Transmitter/Transmitter2
        Chain/Chain1
        Satellite/Satellite/Sensor/downTrans/Transmitter/Transmitter2
    END Instance
    Instance Satellite/Satellite/Sensor/upRecev
        Chain/Chain1
        Satellite/Satellite/Sensor/upRecev
        Satellite/Satellite/Sensor/upRecev/Receiver/Receiver1
    END Instance
    Instance Satellite/Satellite/Sensor/upRecev/Receiver/Receiver1
        Chain/Chain1
        Satellite/Satellite/Sensor/upRecev/Receiver/Receiver1
    END Instance
END References
